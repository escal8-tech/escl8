...
export async function updateBookingConfig(ctx: { businessId: string; userId: string; firebaseUid?: string | null; userEmail?: string | null }, input: {
  email: string;
  businessId: string;
...
export async function updateTimezone(ctx: { businessId: string; userId: string; firebaseUid?: string | null; userEmail?: string | null }, input: {
  email: string;
  businessId: string;
  timezone: string;
}) {
...
export async function updateOrderSettings(ctx: { businessId: string; userId: string; firebaseUid?: string | null; userEmail?: string | null }, input: {
  email: string;
  businessId: string;
...
export async function updateCustomizationSettings(ctx: { businessId: string; userId: string; firebaseUid?: string | null; userEmail?: string | null }, input: {
  email: string;
  businessId: string;
  businessName?: string;
  logoBlobPath?: string;
...
export async function ensureWebsiteWidget(ctx: { businessId: string; userId: string; firebaseUid?: string | null; userEmail?: string | null }, input: {
  email: string;
  businessId: string;
}) {
  if (ctx.userEmail && input.email !== ctx.userEmail) {
...
export async function disconnectGmailConnection(ctx: { businessId: string; userId: string; firebaseUid?: string | null; userEmail?: string | null }, input: {
  email: string;
  businessId: string;
}) {
  if (ctx.userEmail && input.email !== ctx.userEmail) {
...
export async function completeOnboardingSetup(ctx: { businessId: string; userId: string; userEmail?: string | null }, input: {
  businessName: string;
  website?: string;
  phone?: string;
  address?: string;
