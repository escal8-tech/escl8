...
import { invalidateStatsCache, invalidateStatsCacheByPrefix } from "../lib/statsCache";
...
export async function sendText(
  ...
  invalidateStatsCacheByPrefix(`messages:list:${input.threadId}:`);
  invalidateStatsCacheByPrefix(`messages:recentThreads:${ctx.businessId}:`);
