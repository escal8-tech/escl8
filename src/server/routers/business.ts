...
export const businessRouter = router({
  listPhoneNumbers: businessProcedure.query(async ({ ctx }) => {
    return readSupport.listPhoneNumbersForBusiness(ctx.businessId);
  }),
  ...
  setWhatsappIdentityAutoReplyPaused: businessProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      return lifecycleSupport.setWhatsappIdentityAutoReplyPausedForBusiness(ctx, input);
    }),
  ...
  setWhatsappIdentityAiDisabled: businessProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      return lifecycleSupport.setWhatsappIdentityAiDisabledForBusiness(ctx, input);
    }),

  getMine: businessProcedure
    .input(z.object({ email: z.string().email().optional() }).optional().default({}))
    .query(async ({ input, ctx }) => {
      return readSupport.getMineForBusiness(ctx, input.email);
    }),

  getCustomizationPreview: businessProcedure.query(async ({ ctx }) => {
    return readSupport.getCustomizationPreviewForBusiness(ctx.businessId);
  }),
  ...
  updateBookingConfig: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return lifecycleSupport.updateBookingConfigForBusiness(ctx, input);
    }),
  ...
  updateTimezone: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return lifecycleSupport.updateTimezoneForBusiness(ctx, input);
    }),
  ...
  updateOrderSettings: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return lifecycleSupport.updateOrderSettingsForBusiness(ctx, input);
    }),
  ...
  updateCustomizationSettings: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return lifecycleSupport.updateCustomizationSettingsForBusiness(ctx, input);
    }),
  ...
  ensureWebsiteWidget: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return lifecycleSupport.ensureWebsiteWidgetForBusiness(ctx, input);
    }),
  ...
  disconnectGmailConnection: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return lifecycleSupport.disconnectGmailConnectionForBusiness(ctx, input);
    }),
  ...
  completeOnboardingSetup: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      return lifecycleSupport.completeOnboardingSetupForBusiness(ctx, input);
    }),

  getSubscription: businessProcedure.query(async ({ ctx }) => {
    return readSupport.getSubscriptionForBusiness(ctx.businessId);
  }),
});
