...
export const businessRouter = router({
  listPhoneNumbers: businessProcedure.query(async ({ ctx }) => {
    const cacheKey = `business:phoneNumbers:${ctx.businessId}`;
  ...
  setWhatsappIdentityAutoReplyPaused: businessProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      invalidateStatsCache(`business:phoneNumbers:${ctx.businessId}`);
      recordBusinessEvent({
  ...
  updateBookingConfig: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return support.updateBookingConfig(ctx, input);
    }),
  ...
  updateTimezone: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return support.updateTimezone(ctx, input.timezone);
    }),
  ...
  updateOrderSettings: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return support.updateOrderSettings(ctx, input);
    }),
  ...
  updateCustomizationSettings: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return support.updateCustomizationSettings(ctx, input);
    }),
  ...
  completeOnboardingSetup: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      return support.completeOnboardingSetup(ctx, input);
    }),
