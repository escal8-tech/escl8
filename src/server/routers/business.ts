...
export const businessRouter = router({
  listPhoneNumbers: businessProcedure.query(async ({ ctx }) => {
    return support.listPhoneNumbers(ctx);
  }),
  ...
  getCustomizationPreview: businessProcedure.query(async ({ ctx }) => {
    ...
    const { createOrderInvoicePreviewArtifact } = await import("@/server/services/orderInvoice");
  ...
  updateBookingConfig: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return support.updateBookingConfig(ctx as any, input);
    }),
  ...
  updateTimezone: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return support.updateTimezone(ctx as any, input);
    }),
  ...
  updateOrderSettings: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return support.updateOrderSettings(ctx as any, input);
    }),
  ...
  updateCustomizationSettings: businessProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return support.updateCustomizationSettings(ctx as any, input);
    }),
