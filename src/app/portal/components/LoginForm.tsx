  ...
  return (
    <div className="frost-card" style={{ width: "100%", maxWidth: 720, padding: "40px 44px 48px" }}>
      <div style={{ marginBottom: 24, textAlign: "center" }}>
        ...
        <p style={{ fontSize: 14, color: "var(--muted)" }}>Sign in to your Escal8 account</p>
      </div>
      <form onSubmit={onSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "var(--muted)", marginTop: 8 }}>
          Don&apos;t have an account? <a href="/signup" style={{ color: "var(--gold-light)", fontWeight: 500 }}>Sign up</a>
        </p>
      </form>
    </div>
  );
